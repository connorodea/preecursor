...
import { getPillar, CITY_SPOKE_ROUTES } from "@/lib/content/programmatic";

const pillar = getPillar("ai-consultant")!;
const out = renderToStaticMarkup(createElement(Page));

describe("app/ai-consultant/page (pillar)", () => {
  ...
  it("links to its city spokes and sibling pillar", () => {
    for (const route of CITY_SPOKE_ROUTES) {
  ...
  it("exports canonical metadata", () => {
    ...
    expect(metadata.alternates?.canonical).toBe("https://preecursor.com/ai-consultant/");
  });
});
